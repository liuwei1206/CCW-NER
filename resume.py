...
from ner.utils.resume_data import Data
...
def train(data, save_model_dir, seg=True):
    ...
    batch_size = 1  ## model can be trained in any batch_size, here we set it to 1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--savemodel', default="data/model/resume")
